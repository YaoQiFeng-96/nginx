...
void ngx_log_init()
{
    ...
    ngx_log.log_level = p_config->GetIntDefault("LogLevel", NGX_LOG_DEBUG);
...
// ngx_log_stderr(0, "invalid option: \"%s\"", argv[0]);
// ngx_log_stderr(0, "invalid option: %10d", 21); 
// ngx_log_stderr(0, "invalid option: %.6f", 21.378);
// ngx_log_stderr(0, "invalid option: %.6f", 12.999);
// ngx_log_stderr(0, "invalid option: %.2f", 12.999);
// ngx_log_stderr(0, "invalid option: %xd", 1678);
// ngx_log_stderr(0, "invalid option: %Xd", 1678);
